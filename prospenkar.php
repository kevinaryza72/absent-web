                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="prospenkar.php" method="POST">
                                <input autocomplete="off" class="au-input au-input--xl" type="text" name="cari" placeholder="Cari ID atau nama pegawai" />
                                ...
                                <div class="table-responsive table--no-card m-b-30">
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                            <?php 
                                            $cari = $_POST['cari'];
                                            $sql = "SELECT * FROM tb_pegawai WHERE id_pegawai LIKE '%$cari%' OR nama LIKE '%$cari%'";
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="karyawan_edit.php?id_pegawai=<?php echo $row['id_pegawai']; ?>"><button class="btn btn-primary">Ubah</button></a> <a href="hapus.php?id_pegawai=<?php echo $row['id_pegawai']; ?>"><button class="btn btn-danger" onclick="return confirm('yakin ingin dihapus?');">Hapus</button></a></td>

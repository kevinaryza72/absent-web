...
<div class="main-content">
                <div class="section__content section__content--p30">
                                ...
                                <table class="table table-borderless table-striped table-earning" >
                                        ...
                                        <tbody>
                                           <tr>
                                                ...
                                                <input type="text" class="form-control" readonly="" name="id_pegawai" autocomplete="off" value="<?php echo $d['id_pegawai'];?>">   
                                            ...
                                            <tr>
                                                <td>
                                                  ...
                                                  <input type="text" class="form-control" name="tmp_tgl_lahir" autocomplete="off" value="<?php echo $d['tmp_tgl_lahir'];?>"></td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                <td><label for="exampleInputPassword1">Alamat</label>
                                                  <textarea autocomplete="off" class="form-control" name="alamat" value="<?php echo $d['alamat'];?>"></textarea></td>
                                            </tr>
                                            <tr>
                                                <td> <label for="exampleInputPassword1">Telepon</label>
                                                <input type="text" class="form-control"  name="no_tel" value="<?php echo $d['no_tel'];?>"></td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                <td><label for="exampleInputPassword1">Foto</label><br>
                                                  <?php 
                                                  if ($d['foto']!='')
                                                  {
                    ...
                    <input type="file" name="inpfoto">
                                            ...
                                            <tr>
                                                <td><button type="submit" class="btn btn-primary" name="ubahdata">Ubah Data</button></td>
                                            </tr>   
                                  </tbody>
                                </table>
                              </div>

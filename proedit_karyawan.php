...
//proses hapus gambar
      ...
      $sql_f = "UPDATE tb_pegawai set username='$username', password='$password', nama='$nama', tmp_tgl_lahir='$tmp_tgl_lahir', jenkel='$jenkel', agama='$agama', alamat='$alamat', no_tel='$no_tel', jabatan='$jabatan', foto ='$fotobaru' WHERE id_pegawai='$id_pegawai'";
      $ubah  = mysqli_query($koneksi, $sql_f);
      if($ubah){
        echo "<script>alert('Ubah Data Dengan ID Karyawan = ".$id_pegawai." Berhasil') </script>";
        ...
        while ($row = mysqli_fetch_array($query)) {
          ...
          echo "<br><a href=\"edit_karyawan.php?id_pegawai=".$row['id_pegawai']."\"> Kembali Ke From ! </a>";
        }
      }
   ...
   $sql_d   = "UPDATE tb_pegawai set username='$username', password='$password', nama='$nama', tmp_tgl_lahir='$tmp_tgl_lahir', jenkel='$jenkel', agama='$agama', alamat='$alamat', no_tel='$no_tel', jabatan='$jabatan' WHERE id_pegawai='$id_pegawai'";

                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                                        ...
                                        <table class="table table-borderless table-striped table-earning">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>NIP</td>
                                                    <td>
                                                        <input type="text" readonly="" class="form-control" name="id_pegawai" autocomplete="off" size="25px" maxlength="25px" value="<?php echo $_SESSION['idsi']; ?>">
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    if ($sekarang >= $pagi && $sekarang <= strtotime('09:00:00')) {
                                                        echo '<td><button type="submit" name="simpan" class="btn btn-primary pull-right">Absen</button></td>';
                                                    } if ($sekarang >= strtotime('09:00:00')) {
                                                        echo '<td>maaf kamu sudah tidak bisa absen</td>';
                                                    } ?>
                                                    </td>
                                                </tr>
                                            </tbody>
                        ...
                        <div class="header-desktop">
                            <div class="col-md-12">
                                <div class="copyright">
                                    <p>Copyright © 2020 BAPPENDA All rights reserved. Template by <a href="https://colorlib.com">Colorlib</a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>

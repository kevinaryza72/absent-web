        ...
        <div class="page-container">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            ...
                            <h2>Badan Pengelolaan Pendapatan Daerah Kabupaten Bogor</h2>
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <center><img src="img/bpkantor.jpg" width="1000" class="img img-responsive" height="1000"></center><br>
                            <strong class="col-md-12" style="margin-top: 5rem;"><h3><i>Selamat Datang Admin Bappenda Kab.Bogor</i></h3></strong>

...
<td><a href="karyawan_edit.php?id_pegawai=<?php echo $row['id_pegawai']; ?>">
    <button class="btn btn-primary">Ubah</button></a> 
    <a href="hapus.php?id_pegawai=<?php echo $row['id_pegawai']; ?>">
        <button class="btn btn-danger" onclick="return confirm('yakin ingin dihapus?');">Hapus</button></a>
</td>
